	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  ...
			  <a class="nav-link" id="v-pills-analytic-tab" data-toggle="pill" href="#v-pills-analytic" role="tab" aria-controls="v-pills-analytic" aria-selected="false">Analytics</a>
			  <a class="nav-link" id="v-pills-csearch-tab" data-toggle="pill" href="#v-pills-csearch" role="tab" aria-controls="v-pills-csearch" aria-selected="false">Customize Search</a>
			</div>
		</div>
		 <div class="col-lg-10">
						...
						<div id="itemDetailsTab" class="container-fluid tab-pane active">
							...
							<form>
							  ...
							  <div class="form-row">
								  ...
								  <div class="form-group col-md-2">
									<label for="itemDetailsStatus">Min. Stock</label>
									<input type="text" class="form-control" name="min_stock" id="min_stock" autocomplete="off">
								  </div>
								  <div class="form-group col-md-2">
									<label for="itemDetailsStatus">Max. Stock</label>
									<input type="text" class="form-control" name="max_stock" id="max_stock" autocomplete="off">
								  </div>
							  </div>
							  ...
							  <div class="form-row">
								<div class="form-group col-md-6" style="display:inline-block">
								  <label for="itemDetailsDescription">Description</label>
									<textarea rows="8" class="form-control" placeholder="Description" name="itemDetailsDescription" onclick="get_desc()" id="itemDetailsDescription" data-toggle="modal" data-target="#descModal">
HSN:,
BIN:,
RACK:,
MATERIAL TYPE:,
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<tr><td>
        <label>BIN:</label></td>
		<td><input type="number" id="bin"/>
		</td></tr>
		
		
		<tr><td>
        <label>RACK:</label></td>
		<td><input type="number" id="rack"/>
		</td></tr>
		
		<tr><td>
        <label>MATERIAL TYPE:</label></td>
		<td><input type="text" id="m_type"/>
		</td></tr>
		
		<tr><td>
        <label>MACHINE:</label></td>
		<td><input type="text" id="machine"/>
		</td></tr>
		
		<tr><td>
        <label>FIXTURE:</label></td>
		<td><input type="text" id="fixture"/>
		</td></tr>
		
		<tr><td>
        <label>IMPORTED:</label></td>
		<td><select id="imported"/>>
		<option>YES</option>
		<option>NO</option>
		<option>BOTH</option>
		</select>
		...
		<tr><td>
        <label>OTHER DETAILS:</label></td>
		<td><textarea type="textarea" id="other_details"></textarea>
		</td></tr>
		  </table>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" id="add_details_btn" onclick="update_desc()">Save changes</button>
      </div>
    </div>
  </div>
</div>
					...
					<form>
					  <div class="form-row">
						...
						<div class="form-group col-md-3">
						  ...
						  <input type="text" class="form-control datepicker" id="purchaseDetailsPurchaseDate" name="purchaseDetailsPurchaseDate" value="<?= date('Y-m-d') ?>">
						</div>
						<div class="form-group col-md-2">
				  ...
				  <div id="vendorDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-4">
						  <label for="vendorDetailsVendorDistrict">Country</label>
					...
					<form>
					  ...
					  <div class="form-row">
						  ...
						  <div class="form-group col-md-3">
							  ...
							  <input type="text" class="form-control datepicker" id="saleDetailsSaleDate" value="<?= date('Y-m-d') ?>" name="saleDetailsSaleDate">
						  </div>
					  </div>
					  <div class="form-row">
						<div class="form-group col-md-2">
				  ...
				  <div id="customerDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-4">
						  <label for="customerDetailsCustomerDistrict">Country</label>
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									...
									<input type="text" class="form-control datepicker" id="saleReportStartDate" value="<?= date('Y-m-d') ?>" name="saleReportStartDate" >
								  </div>
								  <div class="form-group col-md-3">
									<label for="saleReportEndDate">End Date</label>
									<input type="text" class="form-control datepicker" id="saleReportEndDate" value="<?= date('Y-m-d') ?>" name="saleReportEndDate">
								  </div>
							  </div>
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									...
									<input type="text" class="form-control datepicker" id="purchaseReportStartDate" value="<?= date('Y-m-d') ?>" name="purchaseReportStartDate">
								  </div>
								  <div class="form-group col-md-3">
									<label for="purchaseReportEndDate">End Date</label>
									<input type="text" class="form-control datepicker" id="purchaseReportEndDate" value="<?= date('Y-m-d') ?>" name="purchaseReportEndDate">
								  </div>
							  </div>
...
document.getElementById("itemDetailsDescription").value="HSN:"+hsn+",\nBIN:"+bin+",\nRACK:"+rack+",\nMATERIAL TYPE:"+m_type+",\nMACHINE:"+machine+",\nFIXTURE:"+fixture+",\nIMPORTED:"+imported+",\nOTHER DETAILS:"+other_details;
$('#descModal').modal('hide');
//alert(hsn+" "+bin+" "+rack+" "+m_type+ " "+machine+" "+fixture+" "+imported+" "+ other_details);
}
function get_desc(){
var desc_item=document.getElementById("itemDetailsDescription").value;
const arr1 = desc_item.split(",");
var hsn=arr1[0].split(":");
var bin=arr1[1].split(":");
var rack=arr1[2].split(":");
var m_type=arr1[3].split(":");
var machine=arr1[4].split(":");
var fixture=arr1[5].split(":");
var imported=arr1[6].split(":");
var other_details=arr1[7].split(":");
document.getElementById("hsn").value=hsn[1];
document.getElementById("bin").value=bin[1];
document.getElementById("rack").value=rack[1];
document.getElementById("m_type").value=m_type[1];
document.getElementById("machine").value=machine[1];
document.getElementById("fixture").value=fixture[1];
document.getElementById("imported").value=imported[1];
document.getElementById("other_details").value=other_details[1];
}
